...
const
   ...
   EffectBase: array[0..MAXEFFECT-1] of integer = (
    ...
    200,{2}		//Healing
    400,{3}		//GreatFireBall
    600,{4}		//Poisoning Ê©¶¾Êõ
    0,{5}		//Slaying ¹¥É±½£Êõ
    900,{6}		//Repulsion ¿¹¾Ü»ð»·
    920,{7}		//HellFire µØÓü»ð
    940,{8}		//Lightning ¼²¹âµçÓ°  //No casting effect
    20,{9}		//ThunderBolt À×µçÊõ  Magic2
    940,{10}	//SoulFireBallÁé»ê»ð·û //No casting effect
    940,{11}	//SoulShield ÓÄÁé¶Ü //No casting effect
    940,{12}	//BlessedArmou ÉñÊ¥Õ½¼×Êõ //No casting effect
    0,{13}		//Thrusting ´ÌÉ±½£Êõ
    1380,{14}	//TrapHexagon À¦Ä§Öä
    1500,{15}	//SummonSkele ÕÙ»½÷¼÷Ã
    1520,{16}	//Hiding
    940,{17}	//MassHiding ¼¯ÌåÒþÉíÊõ
    1560,{18}	//Eshock ÓÕ»óÖ®¹â
    1590,{19}	//Teleport Ë²Ï¢ÒÆ¶¯
    1620,{20}	//FireWall »ðÇ½
    1650,{21}	//FireBall ±¬ÁÑ»ðÑæ
    1680,{22}	//ThunderStorm µØÓüÀ×¹â
    0,{23}		//HalfMoon °ëÔÂÍäµ¶
    0,{24}		//FlamingSword ÁÒ»ð½£·¨
    0,{25}		//ShoulderDash Ò°Âù³å×²
    3960,{26}	//Revelation ÐÄÁéÆôÊ¾
    1790,{27}	//MassHealing ÈºÌåÖÎÁÆÊõ
    0,{28}		//SummonShinsu ÕÙ»½ÉñÊÞ Magic2
    3880,{29}	//MagicShield
    3920,{30}	//TurnUndead Ê¥ÑÔÊõ
    3840,{31}	//IceStorm
    0,{32}
    40,{33}
    130, {34}
...
begin
   ...
   //TargetCret := TActor(target);//ÔÚ³öÏÖÓÐÈËÓÃËæ»úÖ®ÀàÊ±£¬½«?èÖÃÄ¿±?
end;
