         ...
         10, 11:  //Male cloth, Female cloth
            begin
               ...
               case g_MouseItem.S.Need of
                  ...
                  4: begin
                        useable := TRUE;
                        line3 := line3 + 'ËùÐè×ª?úµÈ¼?' + IntToStr(g_MouseItem.S.NeedLevel);
                     end;
                  40: begin
                        useable := TRUE;
                  ...
                  44: begin
                        useable := TRUE;
                        line3 := line3 + 'ËùÐè×ª??&?ùÍûµ?' + IntToStr(g_MouseItem.S.NeedLevel);
                     end;
                  5: begin
                        useable := TRUE;
                        line3 := line3 + 'ËùÐè?ùÍûµ?' + IntToStr(g_MouseItem.S.NeedLevel);
                     end;
                  6: begin
                        useable := TRUE;
